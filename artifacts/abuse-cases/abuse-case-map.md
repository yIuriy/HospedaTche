...
| AC22 | accounts | [`accounts/AC22-unauthorized-password-change.md`](./accounts/AC22-unauthorized-password-change.md) | Unauthorized Password Change | Password recovery module | Tampering | draft |
| AC23 | accounts | [`accounts/AC23-legitimate-employee-inactivation.md`](./accounts/AC23-legitimate-employee-inactivation.md) | Legitimate Employee Inactivation | Employee management module | Tampering | draft |
...
| AC02 | booking | [`booking/AC02-Booking-Cancellation-Blocking.md`](./booking/AC02-Booking-Cancellation-Blocking.md) | Booking Cancellation Blocking | Booking cancellation | Denial of Service | draft |
| AC03 | booking | [`booking/AC03-Booking-Information-Disclosure.md`](./booking/AC03-Booking-Information-Disclosure.md) | Booking Information Disclosure | Booking records | Information Disclosure | draft |
...
| AC05 | booking | [`booking/AC05-Fraudulent-Booking-Repudiation.md`](./booking/AC05-Fraudulent-Booking-Repudiation.md) | Fraudulent Booking Repudiation | Audit logs | Repudiation | draft |
