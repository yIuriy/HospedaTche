...
| T04 | accounts | [`accounts/T04-unauthorized-password-change.md`](./accounts/T04-unauthorized-password-change.md) | Unauthorized Password Change | Password recovery module | Tampering | AC22 | draft |
| T05 | accounts | [`accounts/T05-legitimate-employee-inactivation.md`](./accounts/T05-legitimate-employee-inactivation.md) | Legitimate Employee Inactivation | Employee management module | Tampering | AC23 | draft |
...
| T01 | booking | [`booking/T01-Booking-Creation-Repudiation.md`](./booking/T01-Booking-Creation-Repudiation.md) | Booking Creation Repudiation | booking | Repudiation | AC05 | draft |
| T02 | booking | [`booking/T02-Booking-Information-Disclosure.md`](./booking/T02-Booking-Information-Disclosure.md) | Booking Information Disclosure | Booking Records | Information Disclosure | AC03 | draft |
...
| T04 | booking | [`booking/T04-Forced-Booking-Expiration.md`](./booking/T04-Forced-Booking-Expiration.md) | Forced Booking Expiration | Booking Status | Denial of Service | AC04 | draft |
| T05 | booking | [`booking/T05-Duplicate-Booking-Cancellation.md`](./booking/T05-Duplicate-Booking-Cancellation.md) | Duplicate Booking Cancellation | Booking Status | Tampering | AC06 | draft |
| T06 | booking | [`booking/T06-Booking-Cancellation-Blocking.md`](./booking/T06-Booking-Cancellation-Blocking.md) | Booking Cancellation Blocking | Booking Cancellation | Denial of Service | AC02 | draft |
...
| T02 | payments | [`payments/T02-Payment-Confirmation-Blocking.md`](./payments/T02-Payment-Confirmation-Blocking.md) | Payment Confirmation Blocking | Payment Status Synchronization | Denial of Service | AC05 | draft |
| T03 | payments | [`payments/T03-Payment-Synchronization-Flood.md`](./payments/T03-Payment-Synchronization-Flood.md) | Payment Synchronization Flood | Payment Status Synchronization | Denial of Service | AC06 | draft |
| T04 | payments | [`payments/T04-Payment-Reference-Substitution.md`](./payments/T04-Payment-Reference-Substitution.md) | Payment Reference Substitution | Payment Transaction | Tampering | AC01 | draft |
...
| T06 | payments | [`payments/T06-Credit-Card-Information-Disclosure.md`](./payments/T06-Credit-Card-Information-Disclosure.md) | Credit Card Information Disclosure | Payment Information | Information Disclosure | AC03 | draft |
| T01 | accommodation | [`accommodation/T01-room-availability-manipulation.md`](./accommodation/T01-room-availability-manipulation.md) | Room Availability Manipulation | Room availability and blocking module | Tampering | AC01 | draft |
...
| T07 | accommodation | [`accommodation/T07-fraudulent-check-in-or-check-out-update.md`](./accommodation/T07-fraudulent-check-in-or-check-out-update.md) | Fraudulent Check In Or Check Out Update | Stay operation status workflow | Tampering | AC07 | draft |
